...
phase: 5
inputs:
  - R&D expense (current and historical)
  - Amortization period (industry-specific)
outputs:
  - Adjusted EBIT (higher — R&D removed from expenses, amortization added)
  - Research asset value (capitalized R&D)
