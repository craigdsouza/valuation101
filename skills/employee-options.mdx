...
phase: 6
inputs: [options outstanding (number, average strike price, average maturity), current stock price, risk-free rate, stock price standard deviation]
outputs: [total option value (subtracted from equity in the DCF equity bridge)]
