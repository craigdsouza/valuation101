...
phase: 2
inputs: [Ticker, Valuation date, Fiscal year end date]
outputs: [statements_required_{date}.json]
depends_on: [company-identifier]
feeds_into: [pull-raw-data, parse-raw-data-to-filings]
*/}
